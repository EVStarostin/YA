...
#### Pointer Lock Api сделал на отдельной страничке, так как на основном макете хотелось сделать нормально с полосой прокрутки и фиксированными размерами. Ссылка на страничку с Pointer Lock Api http://www.evstar.ru/pointer-lock.html.
